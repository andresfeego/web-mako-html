...
if (!empty($_POST['codigo'])) {
	...
	$sql="select `codigo` ,  `nombre` , `barrio` , `tipo_comercio` ,  `url_logo` , `descripcion` ,  `visto` ,  `cantidad_de_votos` ,  `nuemro_de_votantes` from  `empresa` where  `nombre` like  '%".$_GET['id']."%' and `activo`=1  order by `tipo_comercio` DESC ";
